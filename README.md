...
└────────┬────────────┘
         ...
         ▼
┌─────────────────────┐
│  Repository Layer   │  SQL-запросы через SQLAlchemy
│  (src/repositories/)│
└────────┬────────────┘
         │
         ▼
...
Тестирование проводилось через Locust. Скрипт: locust -f tests/locustfile.py --host=http://localhost:8000 --web-port=8090 
